...
# what should I do? open the test.html in browser and modify statement.js? when following the instructions in the book and the code seprated to 3 different files, still works? yes... you can try out following exactly the book. And for the latter, you are right, export and import in js only works with server. The easiest thing to do, for now, is to keep everything in statement.js rather than split code between files.
