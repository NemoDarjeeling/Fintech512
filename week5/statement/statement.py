import math
# what should I do? open the test.html in browser and modify statement.js?
# when following the instructions in the book and the code seprated to 3 diferent files, still works?
